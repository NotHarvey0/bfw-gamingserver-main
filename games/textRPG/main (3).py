...
classStats = [[4,5,5,10,100],[10,7,3,3,100],[8,10,5,1,100]]
pName = ""
pStats = [0,0,0,0,0]
...
itemsToBuy = [["Trank","Feuerheilung","Eisheilung","Statistikboost"],[75,50,50,100]]
itemsToFind = [["Trank","Feuerheilung","Eisheilung","Statistikboost","Billige Vase","Teure Vase","Müll"],[100,50,50,200,25,300,0]]
monsterTypes = [["Feuerdämon","Eisbandit","Baka the Duck","Schwacher Gegner","MEGA BOSS"],[10,8,3,1,15],[8,5,3,3,9],[5,7,3,1,7],[10,10,3,2,5],[120,120,75,30,100]]
inventory = ["Trank"]
